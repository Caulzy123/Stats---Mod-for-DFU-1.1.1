Special thanks to Rith Essa, the creator of the orignal mods.
...
* If compiling manually: Remove "BETA" from the folder name when creating the final .dfmod container.
...
* Zero Harmony Dependencies: No more .dll file overrides or risky vanilla code hooking. This massively reduces conflicts with other mods.
