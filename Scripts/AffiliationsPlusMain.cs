// StatsPlus Mod
// by Caulzy & RithEssa at Nexus Mods
...
namespace StatsPlus
{
    public class AffiliationsPlusMain : MonoBehaviour
	{
        ...
        public static void OpenAffiliationsWindow()
		{
            if (overrideDefaultSettings == true)
            {
                tab = TextFile.TabToken;
        ...
        public static void GetLocalReputation()
        {
            ...
            if (GameManager.Instance.PlayerGPS != null)
            {
                ...
                //Debug.Log($"[StatsPlus] Raw Current Region Name: '{currentRegionName}'");
        ...
        private void Update()
        {
            // Null safety: DFU UI can be unavailable during early startup/shutdown frames.
            ...
            if (Input.GetKeyDown(KeyCode.A) &&
                ...
                DaggerfallUI.Instance.UserInterfaceManager.TopWindow as DaggerfallCharacterSheetWindow != null)
            {
                OpenAffiliationsWindow();
                openedAffiliationsPlusWindow = true;
            }
        }
